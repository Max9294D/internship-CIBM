...
def main(args):
    ...
    ##################### Test ################
        ...
        test(logger, encoder, attn_decoder, test_data, scale_type, out_scale, intercept=intercept, output_length=output_seq_length,
                                encoder_file='', decoder_file='', encoder_ckpt=enc_ckt, decoder_ckpt=dec_ckt, save_dir=output ) #save_dir=model_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--plot_every", default=200, type=int)

    parser.add_argument("--dataset", default='datasets/wmti_dki_constraint_20200305_19_D10.mat', type=str)
    parser.add_argument("--datapath", default='/home/max/PycharmProjects/DL_estimation2', type=str)
    ...
    parser.add_argument("--input_scaler_filename", default="dki_norm_scaler.gz", type=str) # add this "dki_norm_scaler.gz" if i use my own data
